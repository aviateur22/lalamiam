...
CREATE SEQUENCE if not exists sc_lalamiam.cook_pk_seq START WITH 1 INCREMENT BY 1 NO CYCLE;
ALTER SEQUENCE if exists sc_lalamiam.cook_pk_seq OWNER TO lalamiam;
ALTER SEQUENCE if exists sc_lalamiam.cook_pk_seq OWNED by sc_lalamiam.cook.id;
